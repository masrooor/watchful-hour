...
CREATE TABLE public.attendance_records (
  ...
  status TEXT NOT NULL DEFAULT 'pending' CHECK (status IN ('on-time', 'late', 'absent', 'pending')),
...
CREATE POLICY "Admins can read all attendance" ON public.attendance_records
  FOR SELECT TO authenticated USING (public.has_role(auth.uid(), 'admin'));
